...
int main(int argc, char** argv) {
  ...
  // Start of 1a.
  graph.add(gtsam::BetweenFactor<Pose2>(1, 2, odometry, odometryNoise));
  graph.add(gtsam::BetweenFactor<Pose2>(2, 3, odometry, odometryNoise));
  ...
  Values initial;
  // Start of 1c.
  initial.insert(1, Pose2(0.5,  0.0,  0.10));
  initial.insert(2, Pose2(2.1,  0.2, -0.05));
  initial.insert(3, Pose2(3.8, -0.1,  0.05));
